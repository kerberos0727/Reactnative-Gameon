...
export default class EventCard extends Component {
  constructor(props) {
    super(props);
    var start = null;
    // console.log('this.props.event.$__.scope.availability[0]--->', this.props.event.availability[0])
    // console.log('this.props.event.$__.scope.availability[0].start--->', this.props.event.availability[0].start)
    // console.log('this.props.event.$__.scope.imageUrl--->', this.props.event.$__.scope.imageUrl)
    // console.log('this.props.event.$__.scope.name--->', this.props.event.$__.scope.name)
    // console.log('this.props.event.$__.scope.subname--->', this.props.event.$__.scope.subName)
    // console.log('this.props.event.$__.scope.location.address--->', this.props.event.$__.scope.location.address)
    if (
      this.props.event.availability[0] &&
      this.props.event.availability[0].start
    ) {
      start = new Date();
      start.setTime(this.props.event.availability[0].start);
    }
    this.state = {
