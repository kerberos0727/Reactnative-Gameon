          ...
          <View style={styles.sectionBottom}>
            <View style={{ flex: 1, alignItems: 'flex-start' }}>
              <Button
                ...
                icon={<Icon name={'chevron-left'} size={actuatedNormalize(60)} color="#fff" />}
            ...
            <View style={{ flex: 1, alignItems: 'flex-end' }}>
              <Button
                ...
                icon={<Icon name={'chevron-right'} size={actuatedNormalize(60)} color="#fff" />}
...
const styles = StyleSheet.create({
  ...
  sectionTop: {
    flex: 2,
    alignItems: 'center',
    marginHorizontal: actuatedNormalize(50),
    marginVertical: actuatedNormalize(40),
  },
  sectionMiddle: {
    flex: 4,
    width: '100%',
